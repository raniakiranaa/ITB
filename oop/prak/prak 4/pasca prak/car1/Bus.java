 ...
 */
public class Bus extends Car1 {//Jangan lupa tambahkan kata kunci untuk melakukan polymorphism antar kelas
    ...
    public String printDescription(){
        ...
        if (this.isUsedForLongTrip){
            return ("Mobil ini memiliki " + this.getNumberOfWheels() + " roda dengan kapasitas mesin " + this.getEngineCapacity() + " cc, memiliki kapasitas penumpang " + this.passengerCapacity + " orang, dan digunakan untuk perjalanan jauh");
        } else {
            return ("Mobil ini memiliki " + this.getNumberOfWheels() + " roda dengan kapasitas mesin " + this.getEngineCapacity() + " cc, memiliki kapasitas penumpang " + this.passengerCapacity + " orang, dan tidak digunakan untuk perjalanan jauh");
        }
    }
}